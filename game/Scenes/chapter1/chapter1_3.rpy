label chapter1_3:
    ...
    lhs "네. 아까 환영회 엄청 시끄럽고 정신 없었는데, 선배 덕분에 인내 잘 받아서 편했어요."
    
    show lhs_standard at left_low
    pjy "그래요? 그 말 들으니까 보람 있네요~ 고마워요."
    main "선배는 도우미 자주 하세요?"
    
    show pjy_standard at bounce
    pjy "작년에는 못해고요, 올해는 처음이예요."
    ...
    show pjy_standard at bounce
    pjy "곧 익숙해질 거예요."
    pjy "저는 고향이 전주인데, 저도 처음엔 서울이 너무 복잡해서 정신이 없없거든요."

    show lhs_standard at bounce
    lhs "선배, 근데 진짜 차분하세요. 말도 조곤조곤 하시고요... 딱 이과 여신 느낌이랄까?"
    ...
    pjy "자, 그럼 우리 조 첫 모임을 기념해서 건배할까요?"
