label chapter2_3:
    ...
    pjy "고기 담당, [player_name] 씨~ 지금 고기를 익히는 중이에요, 아니면 태우는 중이에요?"
    main "음… 선배가 드시기 딱 좋은 타이밍을 기다리는 중입니다."
    ...
    "(주연 선배가 내 집게 잡은 손 위로, 그녀의 손을 살짝 겹쳐왔다.)"
    "(순간, 닿은 손등에서 느껴지는 온기에 심장이 덜컥 내려앉았다.)"
    ...
    "시끌벅적했던 바비큐 파티가 무르익을 무렵, 나는 잠시 바람을 쐬러 밖으로 나왔다."
    "고요한 밤공기를 마시며, 누군가와 조용히 걷고 싶다는 생각이 들었다."
