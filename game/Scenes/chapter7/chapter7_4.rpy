label chapter7_4:
    ...
    mnk "그런데, 신입생 환영회에서 낯가리는 [player_name] 씨를 본 후부터… 조금씩, 조금씩, 빠져들게 되었어요."
    ...
    mnk "… 그렇죠. 저도 알고 있어요. [player_name] 씨가 절 어떻게 보고 있을지."
    main "…"
    ...
    with dissolve
    mnk "근데 있잖아요,"
    mnk "제가 [player_name] 씨에 대해 알고 있는 건 어제 말한 것보다 훨씬 많아요."
    ...
    mnk "[player_name] 씨 마음대로 해도 좋으니까…"
