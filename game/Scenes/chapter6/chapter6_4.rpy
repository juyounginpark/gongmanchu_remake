label chapter6_4:
    ...
    main "(여름이 먼저 셀카봉을 꺼낸다)"

    pyr "예전에 우리 같이 사진 찍은 거 기억나?"

    main "아… 초등학교 운동회 때?"

    pyr "맞아. 그때처럼…"
    pyr "이 사진도 오래 간직하고 싶어."
