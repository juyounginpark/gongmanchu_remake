...
label chapter6_3:
    ...
    jsk "음… 이 시는 풀꽃을 이야기하는 것 같지만."
    jsk "사실은 마음의 거리에 대해 말하는 것 같아."
    ...
    jsk "여긴, 단어를 뽑고, 그걸로 짧은 글을 쓰는 체험이야."
    jsk "재밌어 보여서 해보려고 했거든. 같이 할래?"
    ...
    #show jeongseonggyoung_shame at main_position
    jsk "혹시… 너 것도 줄 수 있어?"
